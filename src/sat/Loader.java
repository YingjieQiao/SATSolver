...
public class Loader {
    ...
    private static String skipToProblemLine(BufferedReader br) throws InvalidInputException, IOException {
        ...
        System.out.println("skipToProblemLine");
    ...
    private static int[] parseProblemLine(String line) throws InvalidInputException, IOException {
        ...
        System.out.println("parseProblemLine");
    ...
    private static Graph readClauses(BufferedReader br, int numOfVars, int numOfClauses)
        ...
        System.out.println(clausesString.length());
